...
class ReviewListAdapter : RecyclerView.Adapter<ReviewListAdapter.ReviewViewHolder>() {
    ...
    override fun onCreateViewHolder(
        ...
        val binding: ReviewViewBinding = DataBindingUtil.inflate(
            LayoutInflater.from(parent.context),
            R.layout.review_view,
            parent,
            false
        )
    ...
    inner class ReviewViewHolder(private val binding: ReviewViewBinding) :
    ...
    }//review viewmodel을 만들어서 binding
